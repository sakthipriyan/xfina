...
pub fn parse_axis_xls(bytes: &[u8], filename: Option<&str>) -> Result<ParseResult<DepositAccount>, crate::error::XfinaError> {
...
pub fn parse_axis_bank_statement(bytes: &[u8], filename: Option<&str>) -> Result<ParseResult<DepositAccount>, crate::error::XfinaError> {

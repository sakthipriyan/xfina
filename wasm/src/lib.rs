...
create_wasm_binding!(parse_hdfc_cc, xfina::credit_cards::hdfc::parse_hdfc_statement);
create_wasm_binding!(parse_icici_cc, xfina::credit_cards::icici::parse_icici_statement);
create_wasm_binding!(parse_hdfc_ba, xfina::bank_accounts::hdfc::parse_hdfc_bank_statement);
create_wasm_binding!(parse_icici_ba, xfina::bank_accounts::icici::parse_icici_bank_statement);
...
create_wasm_binding!(parse_axis_ba, xfina::bank_accounts::axis::parse_axis_bank_statement);
